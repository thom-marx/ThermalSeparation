...
model CO2_CO2_MEA_StartUpReboiler_newFormulation_Des "StartUp CO2-CO2-MEA eq. incl. reaction for Desorber new formulation"
...
end CO2_CO2_MEA_StartUpReboiler_newFormulation_Des;
