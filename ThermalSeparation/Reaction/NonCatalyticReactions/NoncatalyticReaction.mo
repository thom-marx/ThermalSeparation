within ThermalSeparation.Reaction.NonCatalyticReactions;
model NoncatalyticReaction "non-catalytic homogeneous reaction"
...
extends BaseReaction(redeclare replaceable package MediumLiquid = 
        ThermalSeparation.Media.BaseMediumLiquidReaction, film=true);
  ...
  ThermalSeparation.Units.ReactionRate r[nR]=reactionRates.r;
