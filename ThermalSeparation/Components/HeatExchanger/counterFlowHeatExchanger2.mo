...
model counterFlowHeatExchanger2
...
// connect(heatFlowHotLiquid,hotLiquidTube.heatPort);
 // connect(heatFlowColdLiquid,coldLiquidTube.heatPort);
  ...
  connect(hotLiquidIn, hotLiquidTube.liquidIn) 
                                             annotation (Line(
      points={{72,-62},{58,-62},{58,30},{-54,30},{-54,19.6}},
      color={255,0,0},
      smooth=Smooth.None));
  connect(hotLiquidTube.liquidOut, hotLiquidOut) 
                                               annotation (Line(
      points={{-54,-19.6},{-54,-64},{-70,-64}},
      color={255,0,0},
      smooth=Smooth.None));
  connect(coldLiquidIn, coldLiquidTube.liquidIn) 
                                               annotation (Line(
      points={{-70,60},{-70,60},{-70,-52},{38,-52},{38,-19.6}},
      color={0,0,255},
      smooth=Smooth.None));
  ...
  connect(hotLiquidOut, hotLiquidOut)   annotation (Line(
      points={{-70,-64},{-62.5,-64},{-62.5,-58},{-55,-58},{-55,-64},{-70,-64}},
      color={0,0,0},
      pattern=LinePattern.None,
      thickness=1,
      smooth=Smooth.None));
