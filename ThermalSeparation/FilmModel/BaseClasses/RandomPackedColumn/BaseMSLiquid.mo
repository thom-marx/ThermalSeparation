...
model BaseMSLiquid
 ...
 extends
    ThermalSeparation.FilmModel.BaseClasses.RandomPackedColumn.BaseMSPackedColumn;
 ...
 replaceable model MassTransferCoeff = 
     ThermalSeparation.HeatAndMassTransfer.RandomPackedColumn.Liquid.BaseLiqMT;
