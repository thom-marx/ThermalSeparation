...
package N2_O2_CO2_H2O "water: N2, O2, CO2, H2O"
  ...
  0,
  0,
1.8}, MMX= {0.0280134, 0.0319988, 0.0440095,  0.01801528}, eq_Tsonopoulos = {1, 1, 1,  6},
  ...
  p_sat=fill(saturationPressure(T),n);
    ...
    annotation (structurallyIncomplete);
        ...
        //pT_explicit:
          ...
          h = (x[4]*cp_water*MM_substances[4] + x[3]*cp_AAS*MM_substances[3])*
                                                                          (T
         - T0) + x[1]*3400*MM_substances[1]*(T - T0) + x[2]*3400*MM_substances[2]*(T - T0);
          //+ x[1]*21e3;
...
redeclare model extends HenryCoefficient
     parameter SI.Pressure henry_H[nSubstance] = {8.51e9,4.25e9, 1.63e8,0}
      "Henry coefficient";
     parameter Real henry_C[nSubstance]={1300,1500,2400,0}
