...
package N2_O2_CO2_SO2_HCl_H2O "water: N2, O2, CO2, SO2, HCl,  H2O"

       constant Real phi[nSubstance]= {1,1,1,1,1,2.26}
  ...
  extends
    ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.PartialWaterBased(has_etaSubstance={false, false, false, false, false,  true}, Tcrit= {    126.2,
     154.58,
     304.12,
     430.8,
     324.6,
  ...
  1.6,
  0,
1.8}, MMX= {0.0280134, 0.0319988, 0.0440095, 0.0640638, 0.03646094,  0.01801528}, eq_Tsonopoulos = {1, 1, 1, 1, 1,  6},
     ...
     nSubstance= 6,
      henry={true,true,true,true,true,false});
...
redeclare model extends HenryCoefficient
     parameter SI.Pressure henry_H[nSubstance] = {8.51e9,4.25e9, 1.63e8,3.95e6,3.48e5,0}
      "Henry coefficient";
     parameter Real henry_C[nSubstance]={1300,1500,2400,2800,9000,0}
