...
package N2_O2_CO2_SO2_HCl_HF_H2O "water: N2, O2, CO2, SO2, HCl, HF, H2O"
  ...
  1.6,
  0,
  0,1.8}, MMX= {0.0280134, 0.0319988, 0.0440095, 0.0640638, 0.03646094, 0.0200063432, 0.01801528}, eq_Tsonopoulos = {1, 1, 1, 1, 1, 1, 6},
     ...
     nSubstance= 7,
     henry={true,true,true,true,true,true,false});
...
redeclare model extends HenryCoefficient
     parameter SI.Pressure henry_H[nSubstance] = {8.51e9,4.25e9, 1.63e8,3.95e6,3.48e5,3.72e3,0}
      "Henry coefficient";
     parameter Real henry_C[nSubstance]={1300,1500,2400,2800,9000,7400,0}
