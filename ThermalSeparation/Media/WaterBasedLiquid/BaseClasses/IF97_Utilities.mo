...
"));
    ...
    package Regions
      ...
      function boilingcurve_p "properties on the boiling curve"
        ...
        input SI.Pressure p "pressure";
        output
          ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.IF97PhaseBoundaryProperties
          bpro "property record";
      protected
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.GibbsDerivs
          g "dimensionless Gibbs funcion and dervatives";
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.HelmholtzDerivs
          f "dimensionless Helmholtz function and dervatives";
...
"));
    ...
    package Basic "Base functions as described in IAWPS/IF97"
      ...
      function f3 "Helmholtz function for region 3: f(d,T)"
        ...
        output
          ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.HelmholtzDerivs
          f "dimensionless Helmholtz function and dervatives wrt delta and tau";
      protected
        Real[40] o "vector of auxiliary variables";
      algorithm
        f.T := T;
      ...
      protected
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.GibbsDerivs
          gibbs "dimensionless Gibbs funcion and dervatives wrt pi and tau";
      algorithm
...
"));
    ...
    package Inverses "efficient inverses for selected pairs of variables"
      ...
      protected
        ...
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.NewtonDerivatives_pT
          nDerivs "derivatives needed in Newton iteration";
      ...
      algorithm
        ...
        while ((i < IterationData.IMAX) and not found) loop
          ...
          f := Basic.f3(d, T);
          nDerivs :=
            ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.Helmholtz_pT(
                                                                      f);
          dp := nDerivs.p - p;
      ...
      protected
        ...
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.HelmholtzDerivs
          f "dimensionless Helmholtz function and dervatives wrt delta and tau";
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.NewtonDerivatives_ph
          nDerivs "derivatives needed in Newton iteration";
      ...
      algorithm
        ...
        while ((i < IterationData.IMAX) and not found) loop
          f := Basic.f3(d, T);
          nDerivs :=
            ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.Helmholtz_ph(
                                                                      f);
          dh := nDerivs.h - h;
          dp := nDerivs.p - p;
      ...
      protected
        ...
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.HelmholtzDerivs
          f "dimensionless Helmholtz function and dervatives wrt delta and tau";
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.NewtonDerivatives_ps
          nDerivs "derivatives needed in Newton iteration";
        Boolean found "flag for iteration success";
        Integer subregion "1 for subregion 3a, 2 for subregion 3b";
      algorithm
        ...
        while ((i < IterationData.IMAX) and not found) loop
          f := Basic.f3(d, T);
          nDerivs :=
            ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.Helmholtz_ps(
                                                                      f);
          ds := nDerivs.s - s;
          dp := nDerivs.p - p;
    ...
    package ByRegion "simple explicit functions for one region only"
      ...
      algorithm
        g := Basic.g1(p, T);
        pro :=
          Common.ThermoFluidSpecial.gibbsToProps_pT(
          g);
      end waterR1_pT;
      ...
      algorithm
        f := Basic.f3(d, T);
        pro :=
          Common.ThermoFluidSpecial.helmholtzToProps_dT(
          f);
    ...
    package TwoPhase
      ...
      algorithm
        ...
        if p < data.PLIMIT4A then
          g := Basic.g1(p, Tsat);
          liq :=
            ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.gibbsToBoundaryProps(
            g);
        else
          dl := Regions.rhol_p_R4b(p);
          f := Basic.f3(dl, Tsat);
          liq :=
            ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.helmholtzToBoundaryProps(
            f);
        end if;
      end waterLiq_p;
      ...
      function waterSat_ph
        ...
        input SI.Pressure p "pressure";
        input SI.SpecificEnthalpy h "specific enthalpy";
        output Common.SaturationProperties pro
          "thermodynamic property collection";
      protected
        SI.Density dl "liquid density";
        SI.Density dv "vapour density";
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.GibbsDerivs
          gl "dimensionless Gibbs funcion and dervatives wrt pi and tau";
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.GibbsDerivs
          gv "dimensionless Gibbs funcion and dervatives wrt pi and tau";
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.HelmholtzDerivs
          fl
      ...
      algorithm
        ...
        pro.cv := ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.cv2Phase(
                    pro.liq,
                    pro.vap,
                    pro.x,
                    pro.T,
      ...
      function waterR4_ph
        ...
        input SI.Pressure p "pressure";
        input SI.SpecificEnthalpy h "specific enthalpy";
        output ThermoFluidSpecial.ThermoProperties_ph pro
          "thermodynamic property collection";
      protected
        SI.Density dl "liquid density";
        SI.Density dv "vapour density";
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.PhaseBoundaryProperties
          liq "phase boundary property record";
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.PhaseBoundaryProperties
          vap "phase boundary property record";
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.GibbsDerivs
          gl "dimensionless Gibbs funcion and dervatives wrt pi and tau";
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.GibbsDerivs
          gv "dimensionless Gibbs funcion and dervatives wrt pi and tau";
...
"));
    ...
    function extraDerivs_ph
      ...
      output
        ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.ExtraDerivatives
    ...
    algorithm
      ...
      if region == 1 then
        ...
        g := Basic.g1(p, T);
        dpro :=
          ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.gibbsToExtraDerivs(
                                                                          g);
      elseif region == 2 then
        T := Basic.tph2(p, h);
        g := Basic.g2(p, T);
      ...
      elseif region == 3 then
        ...
        f := Basic.f3(d, T);
        dpro :=
          ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.helmholtzToExtraDerivs(
          f);
      elseif region == 5 then
...
equations</I>.
      <p>
      <img src=\"../Images/if97.png\" alt=\"Regions and equations of IAPWS-IF97\"></p>
...
(dp/dv)<font size=\"-1\"><sub>s</sub> </font></nobr></td>
 ...
 size=\"-1\"><sub>T</sub></font></nobr> </td>
  ...
  function waterBaseProp_ph "intermediate property record for water"
    ...
    output
      ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.IF97BaseTwoPhase
      aux "auxiliary record";
  protected
    ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.GibbsDerivs g
      "dimensionless Gibbs funcion and dervatives wrt pi and tau";
    ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.HelmholtzDerivs
      f "dimensionless Helmholtz funcion and dervatives wrt delta and tau";
    ...
    ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.PhaseBoundaryProperties
      vap "phase boundary property record";
    ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.GibbsDerivs gl
      "dimensionless Gibbs funcion and dervatives wrt pi and tau";
    ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.GibbsDerivs gv
      "dimensionless Gibbs funcion and dervatives wrt pi and tau";
    ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.HelmholtzDerivs
      fl "dimensionless Helmholtz function and dervatives wrt delta and tau";
    ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.HelmholtzDerivs
      fv "dimensionless Helmholtz function and dervatives wrt delta and tau";
    SI.Temperature t1
  ...
  algorithm
    ...
    elseif (aux.region == 4) then
      ...
      if p < BaseIF97.data.PLIMIT4A then
        ...
        liq := ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.gibbsToBoundaryProps(
                                                         gl);
        vap := ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.gibbsToBoundaryProps(
                                                         gv);
        ...
        liq := ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.helmholtzToBoundaryProps(
                                                             fl);
        vap := ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.helmholtzToBoundaryProps(
                                                             fv);
      ...
      aux.cv := ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.Common.cv2Phase(
          liq,
          vap,
          aux.x,
          aux.T,
  ...
  package ThermoFluidSpecial
    ...
    algorithm
      ...
      if (region == 1) then
        ...
        g := BaseIF97.Basic.g1(p, T);
        pro :=
          Common.ThermoFluidSpecial.gibbsToProps_ph(
          g);
      elseif (region == 2) then
      ...
      elseif (region == 3) then
        ...
        pro :=
          Common.ThermoFluidSpecial.helmholtzToProps_ph(
          f);
      elseif (region == 4) then
    ...
    algorithm
      ...
      if (region == 1) then
        ...
        g := BaseIF97.Basic.g1(p, T);
        pro :=
          Common.ThermoFluidSpecial.gibbsToProps_dT(
          g);
      elseif (region == 2) then
        (p,error) := BaseIF97.Inverses.pofdt125(d=d,T= T,reldd= iter.DELD,region=
                 2);
    ...
    algorithm
      ...
      elseif (region == 3) then
        ...
        f := BaseIF97.Basic.f3(d, T);
        pro :=
          Common.ThermoFluidSpecial.helmholtzToProps_pT(
          f);
      elseif (region == 5) then
        g := BaseIF97.Basic.g5(p, T);
        pro :=
