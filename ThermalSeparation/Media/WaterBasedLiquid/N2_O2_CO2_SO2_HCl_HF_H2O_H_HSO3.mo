...
package N2_O2_CO2_SO2_HCl_HF_H2O_H_HSO3
  "water: N2, O2, CO2, SO2, HCl, HF, H2O, H+, HSO3-"
        constant Real lambda0[nSubstance] = {0,0,0,0,0,0, 0,349.8, 40}
  ...
  1.6,
  0,
  0,1.8, 0,0}, MMX={0.0280134, 0.0319988, 0.0440095, 0.0640638, 0.03646094, 0.0200063432, 0.01801528, 0.00100794, 0.08107114}, eq_Tsonopoulos = {1, 1, 1, 5, 1, 1, 6, 1, 1},
     ...
     nSubstance=9,
     henry={true,true,true,true,true,true,false,false,false},
     nR=1,
    ...
    // 0
     ...
     constant SI.MolarMass MM_substances[n]= MMX;
      ...
      redeclare replaceable model extends BaseProperties(
          ...
          p(stateSelect=if (pT_explicit or ph_explicit) and preferredMediumStates then StateSelect.prefer else StateSelect.default)) "Base properties of water"
...
redeclare model extends HenryCoefficient
     parameter SI.Pressure henry_H[nSubstance] = {8.51e9,4.25e9, 1.63e8,3.95e6,3.48e5,3.72e3,0,0,0}
      "Henry coefficient";
     parameter Real henry_C[nSubstance]={1300,1500,2400,2800,9000,7400,0,0,0}
...
equation
  ...
  ThermalSeparation.Media.Correlations.Reaction.EquilibriumConstant.Concentration
      eqConst(
      nS=nSubstance,
      nR=1,
      c=c,
      ...
      T=propsLiq.T,
      MMX=MMX,
      powerCoeffForward={{0,0,0,1,0,0,0,0,0}},
      powerCoeffReverse={{0,0,0,0,0,0,0,1,1}});
  equation
    K_eq = fill(100,nR);
    K_eq_MWG = eqConst.K_eq_MWG;
         ...
         redeclare model extends ReactionRates
           Correlations.Reaction.ReactionRates.Concentration reactionRate(
             nS=nSubstance,
             nR=1,
             c=c,
             gamma=gamma,
             ...
             T=propsLiq.T,
             MMX=MMX,
             rrc_forward(k_0=100000e6*ones(nR)),
             rrc_reverse(k_0=100000e6*ones(nR)),
             powerCoeffForward={{0,0,0,1,0,0,0,0,0}},
             powerCoeffReverse={{0,0,0,0,0,0,0,1,1}});
         ...
         equation
           r =reactionRate.r;
            k_forward= reactionRate.k_forward;
         end ReactionRates;
...
"));
end N2_O2_CO2_SO2_HCl_HF_H2O_H_HSO3;
