...
package N2_O2_CO2_SO2_HCl_HF_H_HSO3_H2O
  "water: N2, O2, CO2, SO2, HCl, HF, H+, HSO3-, H2O"

        constant Real lambda0[nSubstance] = {0,0,0,0,0,0, 349.8, 40, 0}
  ...
  extends ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.PartialWaterBased(
    ...
    {false, false, false, false, false, false, false, false, true},  Tcrit= {    126.2,
     ...
     324.6,
     461.15,
       0,0, 647.14}, pcrit= {   3.398e6,
     5.043e6,
     7.374e6,
     7.884e6,
     8.31e6,
     6.48e6, 0,0,
     2.2064e7}, Vcrit = {  90.1e-6,
  73.37e-6,
  94.07e-6,
  122e-6,
  222e-6,
  ...
  1.6,
  0,
  0, 0,0,1.8}, MMX= {0.0280134, 0.0319988, 0.0440095, 0.0640638, 0.03646094, 0.0200063432, 0.00100794, 0.08107114, 0.01801528}, eq_Tsonopoulos = {1, 1, 1, 5, 1, 1, 1, 1, 6},
...
equation
  for i in 1:nSubstance loop
    ...
    redeclare model extends DiffusionCoefficient
      ...
      diffCoeff(  redeclare model D_Ions = D_Ions,
              redeclare model D_Molecules =
        D_Molecules,
    T=T, p=p, x=x, nS=nSubstance, has_etaSubstance=has_etaSubstance, eta=eta,ic=ic);
    equation
      D = diffCoeff.D;
...
"));
end N2_O2_CO2_SO2_HCl_HF_H_HSO3_H2O;
