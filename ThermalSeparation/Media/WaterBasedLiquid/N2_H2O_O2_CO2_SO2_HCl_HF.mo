...
package N2_H2O_O2_CO2_SO2_HCl_HF "water: N2, H2O, O2, CO2, SO2, HCl, HF"

       constant Real phi[nSubstance]= {1,2.26,1,1,1,1,1}
  ...
  extends
    ThermalSeparation.Media.WaterBasedLiquid.BaseClasses.PartialWaterBased(has_etaSubstance={false, true, false, false, false, false,  false}, Tcrit= {    126.2,
     647.14,
     154.58,
     304.12,
     430.8,
     324.6,
     461.15}, pcrit={   3.398e6,
     2.2064e7,
     5.043e6,
     7.374e6,
     7.884e6,
     8.31e6,
     6.48e6}, Vcrit= {  90.1e-6,
  55.95e-6,
  73.37e-6,
  94.07e-6,
  122e-6,
  ...
  1.6,
  0,
  0}, MMX= {0.0280134, 0.01801528, 0.0319988, 0.0440095, 0.0640638, 0.03646094, 0.0200063432}, eq_Tsonopoulos = {1, 6, 1, 1, 1, 1, 1},
     ...
     nSubstance= 7,
     henry={true,false,true,true,true,true,true});
...
redeclare model extends HenryCoefficient
     parameter SI.Pressure henry_H[nSubstance] = {8.51e9,0,4.25e9, 1.63e8,3.95e6,3.48e5,3.72e3}
      "Henry coefficient";
     parameter Real henry_C[nSubstance]={1300,0,1500,2400,2800,9000,7400}
