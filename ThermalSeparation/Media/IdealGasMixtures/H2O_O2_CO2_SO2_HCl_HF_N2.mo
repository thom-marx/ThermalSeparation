...
package H2O_O2_CO2_SO2_HCl_HF_N2 "7C, Rauchgas: H2O, O2, CO2, SO2, HCl, HF, N2"

     constant Integer henry[:] = {2,3,4,5,6,7};
     constant SI.Pressure henry_H[:] = {0,4.25e9, 1.63e8, 3.95e6, 3.48e5, 3.72e3, 8.51e9}
    "Henry coefficient";
     constant Real henry_C[:]={0,1500,2400,2800,9000,7400,1300}
...
epsilon_k = { 809.1,106.7, 195.2, 335.4, 344.7, 330, 71.4},
    ...
    fluidConstants={ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.FluidData.H2O,
        ...
        ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.FluidData.SO2,
        ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.FluidData.HCL,
        ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.FluidData.HF,
...
required from medium model \""   + mediumName + "\".");
      ...
      pi =  max(1e-4,p*x[1])*1e-6;//min(p,data.PCRIT)*data.IPSTAR;
    o[1] =  pi^0.25;
  ...
  equation
    ...
    T_sat_water =  max(300,0.5*(650.17534844798 + o[20] - (-4.0*(-0.238555575678490 +
      ...
      hX[1] = (4120*(T_sat_water-0) + 2382e3 + 1875*(T-T_sat_water))*MMX[1];
          hX[2] = 925*MMX[2] * (T- 0);
      hX[3] = 864*MMX[3] * (T-0);
      hX[4] = 622*MMX[4] * (T- 0);
      hX[5] = 799*MMX[5]* (T-0);
