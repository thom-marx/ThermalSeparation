...
package FluidData "Critical data, dipole moments and related data"
  ...
  import
    ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.SingleGasesData;

  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    N2(                chemicalFormula =        "N2",
                       iupacName =              "unknown",
  ...
  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    HCL(               chemicalFormula =        "HCl",
                       iupacName =              "unknown",
                       structureFormula =       "unknown",
                       casRegistryNumber =      "7647-01-0",
                       meltingPoint =            158.35,
                       normalBoilingPoint =      188.12,
                       criticalTemperature =    324.6,
                       criticalPressure =        83.1e5,
                       criticalMolarVolume =     2222e-6,
                       acentricFactor =           0.131,
                       dipoleMoment =             0.0,
                       molarMass =              SingleGasesData.HCL.MM,
                       hasDipoleMoment =       true,
                       hasIdealGasHeatCapacity=true,
                       hasCriticalData =       true,
                       hasAcentricFactor =     true);
  ...
  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    HF(                chemicalFormula =        "HF",
                       iupacName =              "unknown",
                       structureFormula =       "unknown",
                       casRegistryNumber =      "7664-39-3",
                       meltingPoint =            190.15,
                       normalBoilingPoint =      1292.65,
                       criticalTemperature =    461.15,
                       criticalPressure =        64.8e5,
                       criticalMolarVolume =     3448e-6,
                       acentricFactor =           0.329,
                       dipoleMoment =             0.0,
                       molarMass =              SingleGasesData.HCL.MM,
                       hasDipoleMoment =       true,
                       hasIdealGasHeatCapacity=true,
 ...
 constant
  ...
  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    C4H10_n_butane(    chemicalFormula =        "C4H10",
                       iupacName =              "unknown",
                       structureFormula =       "unknown",
  ...
  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    C5H12_n_pentane(   chemicalFormula =        "C5H12",
                       iupacName =              "unknown",
                       structureFormula =       "unknown",
  ...
  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    C6H14_n_hexane(    chemicalFormula =        "C6H14",
                       iupacName =              "unknown",
                       structureFormula =       "unknown",
  ...
  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    C7H16_n_heptane(   chemicalFormula =        "C7H16",
                       iupacName =              "unknown",
                       structureFormula =       "unknown",
  ...
  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    C3H6_propylene(    chemicalFormula =        "C3H6",
                       iupacName =              "unknown",
                       structureFormula =       "unknown",
  ...
  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    C4H8_1_butene(     chemicalFormula =        "C4H8",
                       iupacName =              "unknown",
                       structureFormula =       "unknown",
  ...
  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    C5H10_1_pentene(   chemicalFormula =        "C5H10",
                       iupacName =              "unknown",
                       structureFormula =       "unknown",
  ...
  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    C6H12_1_hexene(    chemicalFormula =        "C6H12",
                       iupacName =              "unknown",
                       structureFormula =       "unknown",
  ...
  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    C7H14_1_heptene(   chemicalFormula =        "C7H14",
                       iupacName =              "unknown",
                       structureFormula =       "unknown",
  ...
  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    C2H2_vinylidene(   chemicalFormula =        "C2H2",
                       iupacName =              "unknown",
                       structureFormula =       "unknown",
  ...
  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    C8H18_n_octane(    chemicalFormula =        "C8H18",
                       iupacName =              "unknown",
                       structureFormula =       "unknown",
  ...
  constant
    ThermalSeparation.Media.Interfaces.Types.IdealGas.FluidConstants
    C8H10_ethylbenz(   chemicalFormula =        "C8H10",
                       iupacName =              "unknown",
                       structureFormula =       "unknown",
