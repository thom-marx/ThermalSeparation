...
package N2_H2O_O2_CO2_SO2 "5 components: N2, H2O, O2, CO2, SO2"
     ...
     constant Integer henry[:] = {1,3,4,5};
          constant SI.Pressure henry_H[:] = {8.51e9,0,4.25e9,1.63e8,3.95e6}
    "Henry coefficient";
     constant Real henry_C[:]={1300,0,1500,2400,2800}
  ...
  extends ThermalSeparation.Media.IdealGasMixtures.BaseClasses.BaseIdealGasMixture(
                              ...
                              nS=5,nSubstance=5, V = {18.5, 13.1, 16.3, 26.7, 41.8},  eq_Tsonopoulos = {1, 6, 1, 1, 5},  sigma = {3.798, 2.641, 3.467, 3.941, 4.112}, epsilon_k = {71.4, 809.1,106.7, 195.2, 335.4},
    ...
    fluidConstants={ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.FluidData.N2,
        ...
        ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.FluidData.SO2},             data=
      {ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.SingleGasesData.N2,
        ...
        ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.SingleGasesData.SO2},                            R_const=data.R_s);
