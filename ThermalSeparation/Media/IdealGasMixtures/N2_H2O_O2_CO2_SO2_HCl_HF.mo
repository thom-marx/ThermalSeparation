...
package N2_H2O_O2_CO2_SO2_HCl_HF "7C, Rauchgas: N2, H2O, O2, CO2, SO2, HCl, HF"
        ...
        constant Integer henry[:] = {1,3,4,5,6,7};
                     constant SI.Pressure henry_H[:] = {8.51e9,0,4.25e9, 1.63e8,3.95e6,3.48e5,3.72e3}
    "Henry coefficient";
     constant Real henry_C[:]={1300,0,1500,2400,2800,9000,7400}
...
epsilon_k = {71.4, 809.1,106.7, 195.2, 335.4, 344.7, 330},
    ...
    fluidConstants={ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.FluidData.N2,
        ...
        ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.FluidData.HF},                                                         data=
