...
package N2_H2O_CO2_O2_SO2 "5 components: N2, H2O, CO2, O2, SO2"
    ...
    "Henry coefficient";
     constant Real henry_C[:]={1300,0,2400,1500,2800}
  ...
  extends ThermalSeparation.Media.IdealGasMixtures.BaseClasses.BaseIdealGasMixture(
                              ...
                              nS=5,nSubstance=5, V = {18.5, 13.1, 26.7, 16.3, 41.8}, eq_Tsonopoulos = {1, 6, 1, 1, 5}, sigma = {3.798, 2.641, 3.941, 3.467, 4.112}, epsilon_k = {71.4, 809.1, 195.2, 106.7, 335.4},
