...
package N2_H2O_CO2_O2_SO2_HCl "6 components: N2, H2O, CO2, O2, SO2, HCl"
    ...
    "Henry coefficient";
     constant Real henry_C[:]={1300,0,2400,1500,2800,9000}
  ...
  extends ThermalSeparation.Media.IdealGasMixtures.BaseClasses.BaseIdealGasMixture(
                              ...
                              nS=6,nSubstance=6,V = {18.5, 13.1, 26.7, 16.3, 41.8, 23.3}, eq_Tsonopoulos = {1, 6, 1, 1, 5, 1},  sigma = {3.798, 2.641, 3.941, 3.467, 4.112, 3.339}, epsilon_k = {71.4, 809.1, 195.2, 106.7, 335.4, 344.7},
    ...
    fluidConstants={ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.FluidData.N2,
        ...
        ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.FluidData.HCL},                                   data=
      {ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.SingleGasesData.N2,
        ...
        ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common.SingleGasesData.HCL},                                                        R_const=data.R_s);
