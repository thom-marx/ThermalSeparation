within ThermalSeparation.BalanceEquations.SprayColumn.Equilibrium;
...
/*** geometry ***/
  replaceable record Geometry =
      ThermalSeparation.Geometry.SprayColumn.Geometry                constrainedby ThermalSeparation.Geometry.StructuredPackedColumn.Geometry
