within ThermalSeparation.BalanceEquations.BaseNonEq.Equilibrium;
...
/*** changes to reduce index: fixed state selection ***/
  output SI.MolarInternalEnergy u_v[n](stateSelect=StateSelect.default);
  ...
  Modelica.SIunits.AmountOfSubstance n_mol_L_i[n,nSL](stateSelect=StateSelect.default);
  Modelica.SIunits.AmountOfSubstance n_mol_V_i[n,nSV](stateSelect=StateSelect.default);
